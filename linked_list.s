...
L67:
	...
	movl	%eax, -16(%ebp)	 # tmp139, item
	movl	$0, -12(%ebp)	 #, count
	jmp	L68	 #
L73:
	movl	-16(%ebp), %eax	 # item, item.9_8
	movl	%eax, 4(%esp)	 # item.9_8,
	movl	$LC6, (%esp)	 #,
	call	_printf	 #
	movl	-16(%ebp), %eax	 # item, _19
	movl	%eax, %edx	 # _37, _38
	shrl	$3, %edx	 #, _38
	addl	$536870912, %edx	 #, _39
	movzbl	(%edx), %edx	 # *_40, _41
	...
	call	___asan_report_load4	 #
L69:
	movl	-16(%ebp), %eax	 # item, tmp140
	movl	(%eax), %eax	 # item_1->value, _10
	movl	%eax, 4(%esp)	 # _10,
	movl	$LC7, (%esp)	 #,
	call	_printf	 #
	movl	-16(%ebp), %eax	 # item, tmp141
	addl	$4, %eax	 #, _20
	movl	%eax, %edx	 # _48, _49
	shrl	$3, %edx	 #, _49
	addl	$536870912, %edx	 #, _50
...
L70:
	...
	call	___asan_report_load4	 #
L71:
	movl	-16(%ebp), %eax	 # item, tmp144
	movl	4(%eax), %eax	 # item_1->next, tmp145
	movl	%eax, -16(%ebp)	 # tmp145, item
	addl	$1, -12(%ebp)	 #, count
	cmpl	$7, -12(%ebp)	 #, count
	jg	L74	 #,
L68:
...
LFB25:
	...
	.cfi_offset 6, -12
	.cfi_offset 3, -16
	movl	8(%ebp), %eax	 # list, tmp125
	movl	%eax, -12(%ebp)	 # tmp125, item_ref
	jmp	L76	 #
L79:
	movl	-12(%ebp), %eax	 # item_ref, _17
	movl	%eax, %edx	 # _17, _18
	shrl	$3, %edx	 #, _18
	addl	$536870912, %edx	 #, _19
	movzbl	(%edx), %edx	 # *_20, _21
	testb	%dl, %dl	 # _21
	setne	%cl	 #, _22
	movl	%eax, %ebx	 # _17, _23
	andl	$7, %ebx	 #, _23
	addl	$3, %ebx	 #, _25
	cmpb	%dl, %bl	 # _21, _25
	setge	%dl	 #, _26
	andl	%ecx, %edx	 # _22, _27
	testb	%dl, %dl	 # _27
	je	L77	 #,
	movl	%eax, (%esp)	 # _17,
	call	___asan_report_load4	 #
L77:
	movl	-12(%ebp), %eax	 # item_ref, tmp126
	movl	(%eax), %eax	 # *item_ref_1, _7
	addl	$4, %eax	 #, tmp127
	movl	%eax, -12(%ebp)	 # tmp127, item_ref
L76:
	movl	-12(%ebp), %eax	 # item_ref, _28
	movl	%eax, %edx	 # _28, _29
	shrl	$3, %edx	 #, _29
	addl	$536870912, %edx	 #, _30
	movzbl	(%edx), %edx	 # *_31, _32
	testb	%dl, %dl	 # _32
	setne	%cl	 #, _33
	movl	%eax, %ebx	 # _28, _34
	andl	$7, %ebx	 #, _34
	addl	$3, %ebx	 #, _36
	cmpb	%dl, %bl	 # _32, _36
	setge	%dl	 #, _37
	andl	%ecx, %edx	 # _33, _38
	testb	%dl, %dl	 # _38
	je	L78	 #,
	movl	%eax, (%esp)	 # _28,
	call	___asan_report_load4	 #
L78:
	movl	-12(%ebp), %eax	 # item_ref, tmp128
	movl	(%eax), %eax	 # *item_ref_1, _5
	cmpl	12(%ebp), %eax	 # target, _5
	jne	L79	 #,
	movl	-12(%ebp), %eax	 # item_ref, tmp129
	movl	(%eax), %edx	 # *item_ref_1, _9
	leal	4(%edx), %eax	 #, _12
	movl	%eax, %ecx	 # _39, _40
	shrl	$3, %ecx	 #, _40
	addl	$536870912, %ecx	 #, _41
	movzbl	(%ecx), %ecx	 # *_42, _43
	testb	%cl, %cl	 # _43
	setne	-25(%ebp)	 #, %sfp
	movl	%eax, %esi	 # _39, _45
	andl	$7, %esi	 #, _45
	leal	3(%esi), %ebx	 #, _47
	cmpb	%cl, %bl	 # _43, _47
	setge	%cl	 #, _48
	andb	-25(%ebp), %cl	 # %sfp, _49
	testb	%cl, %cl	 # _49
	je	L80	 #,
	movl	%eax, (%esp)	 # _39,
	call	___asan_report_load4	 #
L80:
	movl	4(%edx), %edx	 # _9->next, _10
	movl	-12(%ebp), %eax	 # item_ref, tmp130
	movl	%edx, (%eax)	 # _10, *item_ref_1
	nop
	addl	$48, %esp	 #,
	popl	%ebx	 #
	.cfi_restore 3
...
LFB26:
	...
	movl	$8, (%esp)	 #,
	call	_malloc	 #
	movl	%eax, -28(%ebp)	 # tmp135, new_item
	movl	-28(%ebp), %eax	 # new_item, _18
	movl	%eax, %edx	 # _25, _26
	shrl	$3, %edx	 #, _26
	addl	$536870912, %edx	 #, _27
	movzbl	(%edx), %edx	 # *_28, _29
	testb	%dl, %dl	 # _29
	setne	%cl	 #, _30
	movl	%eax, %ebx	 # _25, _31
	andl	$7, %ebx	 #, _31
	addl	$3, %ebx	 #, _33
	cmpb	%dl, %bl	 # _29, _33
	setge	%dl	 #, _34
	andl	%ecx, %edx	 # _30, _35
	testb	%dl, %dl	 # _35
	je	L82	 #,
	movl	%eax, (%esp)	 # _25,
	call	___asan_report_store4	 #
L82:
	movl	-28(%ebp), %eax	 # new_item, tmp136
	movl	12(%ebp), %edx	 # new_value, tmp137
	movl	%edx, (%eax)	 # tmp137, new_item_5->value
	movl	8(%ebp), %eax	 # list, tmp138
	movl	%eax, -36(%ebp)	 # tmp138, prev_item
	movl	$0, -32(%ebp)	 #, i
	jmp	L83	 #
L85:
	movl	-36(%ebp), %eax	 # prev_item, _36
	movl	%eax, %edx	 # _36, _37
	shrl	$3, %edx	 #, _37
	addl	$536870912, %edx	 #, _38
	movzbl	(%edx), %edx	 # *_39, _40
	testb	%dl, %dl	 # _40
	setne	%cl	 #, _41
	movl	%eax, %ebx	 # _36, _42
	andl	$7, %ebx	 #, _42
	addl	$3, %ebx	 #, _44
	cmpb	%dl, %bl	 # _40, _44
	setge	%dl	 #, _45
	andl	%ecx, %edx	 # _41, _46
	testb	%dl, %dl	 # _46
	je	L84	 #,
	movl	%eax, (%esp)	 # _36,
	call	___asan_report_load4	 #
L84:
	movl	-36(%ebp), %eax	 # prev_item, tmp139
	movl	(%eax), %eax	 # *prev_item_1, _12
	addl	$4, %eax	 #, tmp140
	movl	%eax, -36(%ebp)	 # tmp140, prev_item
	addl	$1, -32(%ebp)	 #, i
L83:
	movl	-32(%ebp), %eax	 # i, tmp141
	cmpl	16(%ebp), %eax	 # index, tmp141
	jl	L85	 #,
	movl	-36(%ebp), %eax	 # prev_item, _47
	movl	%eax, %edx	 # _47, _48
	shrl	$3, %edx	 #, _48
	addl	$536870912, %edx	 #, _49
	movzbl	(%edx), %edx	 # *_50, _51
	...
	call	___asan_report_load4	 #
L86:
	movl	-36(%ebp), %eax	 # prev_item, tmp142
	movl	(%eax), %edi	 # *prev_item_1, _15
	movl	-28(%ebp), %eax	 # new_item, tmp143
	addl	$4, %eax	 #, _19
	...
	testb	%dl, %dl	 # _62
	setne	%bl	 #, _63
	movl	%eax, %esi	 # _58, _64
	andl	$7, %esi	 #, _64
	leal	3(%esi), %ecx	 #, _66
	cmpb	%dl, %cl	 # _62, _66
	setge	%dl	 #, _67
	andl	%ebx, %edx	 # _63, _68
	testb	%dl, %dl	 # _68
	je	L87	 #,
	movl	%eax, (%esp)	 # _58,
	call	___asan_report_store4	 #
L87:
	movl	-28(%ebp), %eax	 # new_item, tmp144
	movl	%edi, 4(%eax)	 # _15, new_item_5->next
	movl	-36(%ebp), %eax	 # prev_item, tmp145
	movl	-28(%ebp), %edx	 # new_item, tmp146
	movl	%edx, (%eax)	 # tmp146, *prev_item_1
	nop
	addl	$44, %esp	 #,
	popl	%ebx	 #
	.cfi_restore 3
...
LFE26:
	...
	.align 4
LC9:
	.ascii "2 32 4 7 my_list 96 24 6 values \0"
...
L88:
	...
	movl	$1102416563, (%edi)	 #,
	movl	$LC9, 4(%edi)	 #,
	movl	$LASANPC27, 8(%edi)	 #,
	movl	%edi, %ebx	 # tmp89, tmp92
	shrl	$3, %ebx	 #, tmp92
	movl	$-235802127, 536870912(%ebx)	 #,
	movl	$-185273340, 536870916(%ebx)	 #,
	movl	$-218959118, 536870920(%ebx)	 #,
	movl	$-201326592, 536870924(%ebx)	 #,
	movl	$-202116109, 536870928(%ebx)	 #,
	call	___main	 #
	movl	$3, -64(%esi)	 #, values
	movl	$5, -60(%esi)	 #, values
	movl	$7, -56(%esi)	 #, values
	movl	$9, -52(%esi)	 #, values
	movl	$11, -48(%esi)	 #, values
	movl	$13, -44(%esi)	 #, values
	movl	$24, 4(%esp)	 #,
	leal	-64(%esi), %eax	 #, tmp94
	movl	%eax, (%esp)	 # tmp94,
	call	_create_contiguous	 #
	movl	%eax, -128(%esi)	 # tmp96, my_list
	movl	-128(%esi), %eax	 # my_list.head, tmp97
	movl	%eax, 44(%esp)	 # tmp97, target
	movl	-128(%esi), %eax	 # my_list, tmp98
	movl	%eax, (%esp)	 # tmp98,
	call	_print_list	 #
	movl	$1, 8(%esp)	 #,
	movl	$2, 4(%esp)	 #,
	leal	-128(%esi), %eax	 #, tmp99
	movl	%eax, (%esp)	 # tmp99,
	call	_insert_element	 #
	movl	-128(%esi), %eax	 # my_list, tmp100
	movl	%eax, (%esp)	 # tmp100,
	call	_print_list	 #
	movl	$0, %eax	 #, _13
